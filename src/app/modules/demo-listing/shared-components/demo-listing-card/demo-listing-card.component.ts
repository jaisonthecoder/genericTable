...
@Component({
  selector: 'app-demo-listing-card',
  templateUrl: './demo-listing-card.component.html',
  styleUrls: ['./demo-listing-card.component.scss']
})
export class DemoListingCardComponent implements OnInit {
